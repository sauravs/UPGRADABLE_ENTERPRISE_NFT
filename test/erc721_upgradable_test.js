...
=======
  describe("Testing VIP List Related Functionality", function () {                         
    ...
    it("Checking if VIP List is set properly", async function () {                 // test failing
      ...
      const check = await web3tech_erc721_upgradable.connect(owner).addVIPList([receiver.address]);
      console.log(check)
      // console.log(check);
      // const isVIP = await web3tech_erc721_upgradable.isVIPlist(nonOwner2.address);
      // console.log("Checking the output", isVIP.toString());
      // for (let i = 0; i < users.length; i++) {
    ...
    it("Cheking  if  VIP is added", async function () {
      const isVIP = await web3tech_erc721_upgradable.checkVIP(owner.address);
      console.log("Checking the output", isVIP.toString());
      // expect(isVIP).to.be.true
    })
